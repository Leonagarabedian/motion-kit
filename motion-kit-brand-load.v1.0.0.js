(function (global) {
  ...
  const STYLE_ID = "motion-kit-brand-load-v1-styles";
  ...
  function addStyles(doc) {
    ...
    style.textContent = `
      [data-mk-brand-root] {
        perspective: var(--mk-brand-perspective, 600px);
      }
  ...
  function wrapSelectedLetters(element, selectedLetters) {
    ...
    const walker = doc.createTreeWalker(element, filter.SHOW_TEXT);
    const textNodes = [];
  ...
  global.MotionKit.brandLoadVersion = "1.0.0";
})(window);
